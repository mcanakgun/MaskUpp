...
class MapClean extends StatefulWidget {
  @override
  _MapCleanState createState() => _MapCleanState();
}

class _MapCleanState extends State<MapClean> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    setState(() {
      ...
      _circles.add(
        Circle(
          circleId: CircleId("1"),
          center: LatLng(41.073765, 28.770912),
          radius: 650,
          strokeWidth: 2,
          fillColor: Color.fromRGBO(0, 255, 0, 0.5),
        ),
      );
    });
  }
        ...
        children: [
          GoogleMap(
            initialCameraPosition: CameraPosition(
              target: LatLng(41.073765, 28.770912),
              zoom: 15,
            ),
